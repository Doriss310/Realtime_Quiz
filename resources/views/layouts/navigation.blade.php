<nav x-data="{ open: false }" class="bg-[#0a0a23]">
    <style>
        header {
            display: flex;
            ...
            height: 70px;
            width: 100%; /* Chiều cao của header */
        }
        .website-logo {
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex h-16" style="
    justify-content: space-around;
">
            <div class="flex sm:ml-96">
                <!-- Logo -->
                <header>
                    <nav class="homepage-navbar"><a target="_blank" rel="noreferrer" href="http://127.0.0.1:8000/"><img
                                class="website-logo" src="/assets/fcc_primary_large-BET8Cs_b.webp" alt="freeCodeCamp logo"></a>
                    </nav>
                </header>
            </div>

            <!-- Settings Dropdown -->
            <div class="hidden sm:flex sm:items-center lg:px-9" style="white-space: nowrap;">
                @auth
